...
public class ClassChangeManager : MonoBehaviour
{
    ...
    public void AllowChanges()
    {
        ...
        foreach (int id in Manager.SelectedUBClassChange.GetComponent<UnitBehavior>().KnownClasses)
        {
            
            switch (id)
            {
                case 101:  ClassChangeManagerSprites[0].color = new Color(1,1,1, 1) ; ClassChangeManagerButtons[0].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(101, ImprovisedWeapon[0]));  break;
                case 106:   ClassChangeManagerSprites[1].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[1].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(106, ImprovisedWeapon[3]));  break;
                case 102:   ClassChangeManagerSprites[2].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[2].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(102, ImprovisedWeapon[1]));  break;
                case 103:  ClassChangeManagerSprites[3].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[3].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(103, ImprovisedWeapon[2]));  break;
                case 104:  ClassChangeManagerSprites[4].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[4].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(104, ImprovisedWeapon[4]));  break;
                case 105:   ClassChangeManagerSprites[5].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[5].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(105, ImprovisedWeapon[5]));  break;
                case 107:   ClassChangeManagerSprites[6].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[6].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(107, ImprovisedWeapon[0]));  break;
                case 201:   ClassChangeManagerSprites[7].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[7].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(201, ImprovisedWeapon[0]));  break;
                case 202:   ClassChangeManagerSprites[8].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[8].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(202, ImprovisedWeapon[0]));  break;
                case 203:   ClassChangeManagerSprites[9].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[9].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(203, ImprovisedWeapon[0]));  break;
                case 204:   ClassChangeManagerSprites[10].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[10].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(204, ImprovisedWeapon[3])); break;
                case 205:   ClassChangeManagerSprites[11].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[11].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(205, ImprovisedWeapon[3])); break;
                case 206:   ClassChangeManagerSprites[12].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[12].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(206, ImprovisedWeapon[1])); break;
                case 207:   ClassChangeManagerSprites[13].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[13].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(207, ImprovisedWeapon[2])); break;
                case 208:  ClassChangeManagerSprites[14].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[14].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(208, ImprovisedWeapon[2])); break;
                case 209:  ClassChangeManagerSprites[15].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[15].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(209, ImprovisedWeapon[2])); break;
                case 210:  ClassChangeManagerSprites[16].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[16].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(210, ImprovisedWeapon[4])); break;
                case 211:  ClassChangeManagerSprites[17].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[17].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(211, ImprovisedWeapon[4])); break;
                case 212:  ClassChangeManagerSprites[18].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[18].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(212, ImprovisedWeapon[5])); break;
                case 213:  ClassChangeManagerSprites[19].color = new Color(1, 1, 1, 1); ClassChangeManagerButtons[19].GetComponentInChildren<Button>().onClick.AddListener(() => Manager.ClassChange(213, ImprovisedWeapon[0])); break;
