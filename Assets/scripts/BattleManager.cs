...
public class BattleManager : MonoBehaviour
{
    ...
    public int PickTargeting2(UnitBehavior ub, List<UnitBehavior> unitList)
    {
        ...
        switch (ub.target2)
        {
            ...
            case "primeira posi��o": return FirstTargeting(ub, unitList);
            case "segunda posi��o": return SecondTargeting(ub, unitList);
            case "terceira posi��o": return TerceiroTargeting(ub, unitList);
